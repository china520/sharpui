...
suic::Map<suic::String, suic::ObjectPtr> GlyphFactory::_glyphs;
...
{
    suic::Map<suic::String, suic::ObjectPtr>::iterator iter = _glyphs.find(key);
...
void TextBoxDoc::GetText(suic::String & text) const
{
    for (int i = 0; i < (int)_lines.size(); ++i)
    {
        suic::String strline;
