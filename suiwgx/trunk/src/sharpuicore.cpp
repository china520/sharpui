...
static bool ui_is_initialized = false;
...
void SHARPUI_API uiInitialize()
{
    ...
    {
        ui_is_initialized = true;

        suic::SystemHelper::suiInitialize();

        suic::Builder::RegisterElement(_T("Button"), &ui::Button::Create);
        ...
        suic::Builder::RegisterElement(_T("StackPanel"), &ui::StackPanel::Create);
        ...
        suic::Builder::RegisterElement(_T("ComboBox"), &ui::ComboBox::Create);
        suic::Builder::RegisterElement(_T("CheckButton"), &ui::CheckButton::Create);
        suic::Builder::RegisterElement(_T("RadioButton"), &ui::RadioButton::Create);
        suic::Builder::RegisterElement(_T("ScrollBar"), &ui::ScrollBar::Create);

        suic::Builder::RegisterElement(_T("AnimateBox"), &ui::AnimateBox::Create);
        suic::Builder::RegisterElement(_T("ListBox"), &ui::ListBox::Create);   
        ...
        suic::Builder::RegisterElement(_T("TextBox"), &ui::TextBox::Create);
        ...
        suic::Builder::RegisterElement(_T("ToolBarItem"), &ui::ToolBarItem::Create);
    }
}
...
void uiUninitialize()
{
    //if (ui_is_initialized)
    {
        suic::SystemHelper::suiUninitialize();
        ui_is_initialized = false;
    }
}
