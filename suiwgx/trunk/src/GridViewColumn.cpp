    ...
    , _prevWidth(0)
{
    ...
    _header->HeaderGripper()->AddHandler(GridViewColumnHeader::MouseLButtonDownEvent, new suic::MouseEventHandler(this, &GridViewColumn::OnHeaderGripperStarted));
    _header->HeaderGripper()->AddHandler(GridViewColumnHeader::MouseMoveEvent, new suic::MouseEventHandler(this, &GridViewColumn::OnHeaderGripperResize));
    _header->HeaderGripper()->AddHandler(GridViewColumnHeader::MouseLButtonUpEvent, new suic::MouseEventHandler(this, &GridViewColumn::OnHeaderGripperCompleted));
}
